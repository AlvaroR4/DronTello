...
class ArucoDetectorNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(f"Usando diccionario ArUco: {ARUCO_DICT}, tamaño marcador: {MARKER_SIZE} m, focal: {FOCAL_PIXELS} px")
