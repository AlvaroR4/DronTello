...
class VisualizadorPuertas(Node):
    ...
    def bucle_visualizacion(self):
        ...
        # [P1(3), P2(3), P3(3), P4(3), Centro(3), Yaw(1)]
        TAMANO_BLOQUE = 16
        ...
        for i in range(num_puertas):
            ...
            p1 = self.datos_puertas[base:base+3]
            p2 = self.datos_puertas[base+3:base+6]
            p3 = self.datos_puertas[base+6:base+9]
            p4 = self.datos_puertas[base+9:base+12]
            centro = self.datos_puertas[base+12:base+15]
            yaw_deg = self.datos_puertas[base+15]
